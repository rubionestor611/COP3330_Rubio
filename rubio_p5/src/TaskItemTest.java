...
class TaskItemTest {
    ...
    public void constructorFailsWithInvalidDueDate(){
        ...
        assertThrows(DateTimeException.class, () -> {
                t = new TaskItem("Title", "Desc", "2020-02-30");
        });
    }
    @Test
    public void constructorFailsWithInvalidTitle(){
        TaskItem t;
        assertThrows(DateTimeException.class, () -> {
                t = new TaskItem("", "Desc", "2020-02-04");
        });
    }
    @Test
